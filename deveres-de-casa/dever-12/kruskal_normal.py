...
class Grafo:
    ...
    # O Algoritmo de Kruskal Principal
    def executar_kruskal(self):
        ...
        # Passo 1: Ordenar todas as arestas do menor para o maior peso
